...
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Induc3R1dm52cmZpcW1vaHRrZm1lIiwicm9sZSI6ImFub24iOjE3OTAyMTE1MzksImV4cCI6MjEwNTc4NzUzOX0.AY-gLTVCQVqu3skr0feamHZRt7-Lob8ls3Ab7SDTVxM'; 
...
document.getElementById("form-admin").addEventListener("submit", async (e) => {
    ...
    try {
        ...
        // 1. Proses Upload Logo Sekolah jika dipilih
        ...
        // 2. Proses Upload Brosur per Tingkatan
